...
public class APIGatewayTest06 {

	private final Logger logger = LoggerFactory.getLogger(APIGatewayTest06.class);
	...
	public void test_gateway_06() throws ExecutionException, InterruptedException {
		...
		System.out.println("---------------------------------------------------------------------------");
		System.out.println("APIGatewayTest06#test_gateway_06().HttpStatement: " + configuration.getHttpStatement("/wg/activity/sayHi").toString());
		System.out.println("---------------------------------------------------------------------------");
