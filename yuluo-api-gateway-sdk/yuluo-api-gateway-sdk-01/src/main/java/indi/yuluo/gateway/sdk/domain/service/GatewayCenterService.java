package indi.yuluo.gateway.sdk.domain.service;
...
import indi.yuluo.gateway.sdk.common.Result;
import indi.yuluo.gateway.sdk.exception.GatewayException;
...
public class GatewayCenterService {
	...
	public void doRegisterApplicationInterfaceMethod(
		...
		String resultStr;
		try {
			resultStr = HttpUtil.post("http://localhost:8001/wg/admin/register/registerApplicationInterfaceMethod", paramMap, 550);
		}
		catch (Exception e) {
