...
public class ApiGatewayTest04 {

	private final Logger logger = LoggerFactory.getLogger(ApiGatewayTest04.class);

	@Test
	public void test_gateway_04() throws ExecutionException, InterruptedException {
