package indi.yuluo.gateway.center.domain.operation.service;

import java.util.List;

import javax.annotation.Resource;

import indi.yuluo.gateway.center.application.IDataOperationManageService;
...
import indi.yuluo.gateway.center.domain.operation.repository.IDataOperationManageRepository;
...
public class DataOperationManageService implements IDataOperationManageService {
	...
	private static final Logger logger = LoggerFactory.getLogger(DataOperationManageService.class);
